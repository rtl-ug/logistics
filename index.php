            ...
            <div class="row justify-content-between">
                ...
                <div class="col-lg-6">
                    <div class="single_service_text">
                        ...
                        <h4>Flexibility</h4>
                        <p>Experts in handling and delivering of sophisticated IT equipment.</p>
                    </div>
                    <div class="single_service_text">
                        <img src="img/icon/service_2.svg" alt="">
                        <h4>Delivery</h4>
                        <p>Experts in clearing and forwarding all products and services.</p>
                    </div>
                    <div class="single_service_text">
                        <img src="img/icon/service_3.svg" alt="">
                        <h4>Transport</h4>
                        <p>Vast experience in sea and air shipping services.</p>
                    </div>
                    <div class="single_service_text">
                        <img src="img/icon/service_4.svg" alt="">
                        <h4>Inventory Storage</h4>
                        <p>Warehousing service providers and delivery agents within and outside Uganda.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row d-flex align-items-center justify-content-between">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="password" class="form-control" id="inputPassword5"
                                        placeholder="Departure" onfocus="this.placeholder = ''"
                                        onblur="this.placeholder = 'Departure'">
                                </div>
                                <div class="form-group col-md-6">
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="reservation_text">
                        ...
                        <p>We pride ourselves in providing the best transport & shipping services available all over the world.
                        </p>
