               ...
               <div class="col-xl-3 col-sm-6">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="single-footer-widget footer_3 mt_30">
                        <h4>Newsletter</h4>
                        <p>Signup for our newsletter here to receive weekly updates</p>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <p class="footer-text m-0">
                                        Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Powered by <a href="https://rtl.ug" target="_blank">RTL Ug</a>
                                    </p>
                                </div>
                                <div class="col-lg-4">
